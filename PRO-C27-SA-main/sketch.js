...
var brokenboatspritedata , brokenboatspritesheeet 
...
function preload() {
  ...
  brokenboatspritesheeet = loadImage("assets/boat/brokenBoat.png")
...
function setup() {
  ...
  for(var i  = 0 ; i < brokenBoatFrames.length ; i++){
    ...
    var img = brokenboatspritesheeet.get(pos.x,pos.y,pos.w,pos.h)
